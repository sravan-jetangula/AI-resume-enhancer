...
✔ Real-world HR Tech problem
✔ Applied Generative AI (not theory)
✔ End-to-end product mindset
✔ Recruiter-friendly use case
...
🔗 GitHub: [https://github.com/sravan-jetangula](https://github.com/sravan-jetangula.
## 📜 License
